    ...
    void on_batch_update_R(const std::vector<DELTA_R_entry>::iterator &begin, const std::vector<DELTA_R_entry>::iterator &end) {
        ...
        dV2_R.clear();
        {
            ...
            while (e2) {
                ...
                RingSum& v2 = e2->__av;
                dV2_R.addOrDelOnZero(se2.modify(zip, rain), (v2 * c1));
                e2 = e2->nxt;
            }
        }

        {
            ...
            while (e3) {
                ...
                RingSum& v3 = e3->__av;
                V1_R.addOrDelOnZero(se3.modify(zip, rain, prize), v3);
                e3 = e3->nxt;
            }
        }

        {
            ...
            while (e4) {
                ...
                int8_t rain = e4->rain;
                RingSum& v4 = e4->__av;
                V2_R.addOrDelOnZero(se4.modify(zip, rain), v4);
                e4 = e4->nxt;
            }
        }

        {
            ...
            while (e5) {
                ...
                int8_t rain = e5->rain;
                RingSum& v5 = e5->__av;
                V3_R.addOrDelOnZero(se5.modify(zip), (v5 * c1));
                e5 = e5->nxt;
            }
        }
    }
