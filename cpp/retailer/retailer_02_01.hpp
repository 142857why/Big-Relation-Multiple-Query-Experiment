...
extern std::vector<int> number_scan;
extern int number_view;
...
namespace dbtoaster {
    ...
    struct R_entry {
        ...
        explicit R_entry(const int c0, const int c1, const int c2, const int c3, const int c4, const int c5,
                         const int c6, const int c7, const int c8, const DOUBLE_TYPE c9, const int c10, const int c11,
                         const int c12, const int c13, const int c14, const int c15, const int c16, const int c17,
                         const int c18, const int8_t c19, const int8_t c20, const int8_t c21, const DOUBLE_TYPE c22,
                         const int c23, const int c24, const int c25, const int c26, const int c27,
                         const DOUBLE_TYPE c28, const DOUBLE_TYPE c29, const DOUBLE_TYPE c30, const DOUBLE_TYPE c31,
                         const DOUBLE_TYPE c32, const DOUBLE_TYPE c33, const DOUBLE_TYPE c34, const DOUBLE_TYPE c35,
                         const int8_t c36, const int8_t c37, const int c38, const int c39, const DOUBLE_TYPE c40,
                         const int8_t c41, const int c42, const long c43) {
            locn = c0;
            ksn = c1;
            dateid = c2;
            zip = c3;
            ...
            sell_area_sq_ft = c26;
            avghhi = c27;
            supertargetdistance = c28;
            supertargetdrivetime = c29;
            targetdistance = c30;
            targetdrivetime = c31;
            walmartdistance = c32;
            walmartdrivetime = c33;
            walmartsupercenterdistance = c34;
            walmartsupercenterdrivetime = c35;
            rain = c36;
            snow = c37;
            maxtemp = c38;
            mintemp = c39;
        ...
        R_entry(const R_entry &other) : locn(other.locn), ksn(other.ksn), dateid(other.dateid), zip(other.zip),
                                        population(other.population), white(other.white), asian(other.asian),
                                        pacific(other.pacific), black(other.black), medianage(other.medianage),
                                        occupiedhouseunits(other.occupiedhouseunits), houseunits(other.houseunits),
                                        families(other.families), households(other.households),
                                        husbwife(other.husbwife), males(other.males), females(other.females),
                                        householdschildren(other.householdschildren), hispanic(other.hispanic),
                                        subcategory(other.subcategory), category(other.category),
                                        categorycluster(other.categorycluster), prize(other.prize),
                                        rgn_cd(other.rgn_cd), clim_zn_nbr(other.clim_zn_nbr),
                                        tot_area_sq_ft(other.tot_area_sq_ft), sell_area_sq_ft(other.sell_area_sq_ft),
                                        avghhi(other.avghhi), supertargetdistance(other.supertargetdistance),
                                        supertargetdrivetime(other.supertargetdrivetime),
                                        targetdistance(other.targetdistance), targetdrivetime(other.targetdrivetime),
                                        walmartdistance(other.walmartdistance),
                                        walmartdrivetime(other.walmartdrivetime),
                                        walmartsupercenterdistance(other.walmartsupercenterdistance),
                                        walmartsupercenterdrivetime(other.walmartsupercenterdrivetime),
                                        rain(other.rain), snow(other.snow), maxtemp(other.maxtemp),
                                        mintemp(other.mintemp), meanwind(other.meanwind), thunder(other.thunder),
                                        inventoryunits(other.inventoryunits), __av(other.__av), nxt(nullptr),
                                        prv(nullptr) {}
        ...
        R_entry(const std::vector <std::string> &f, const long v) {
            ...
            dateid = std::stoi(f[2]);
            zip = std::stoi(f[3]);
            population = std::stoi(f[4]);
            white = std::stoi(f[5]);
            asian = std::stoi(f[6]);
            pacific = std::stoi(f[7]);
            black = std::stoi(f[8]);
            medianage = std::stod(f[9]);
            occupiedhouseunits = std::stoi(f[10]);
            houseunits = std::stoi(f[11]);
            families = std::stoi(f[12]);
            households = std::stoi(f[13]);
            husbwife = std::stoi(f[14]);
            males = std::stoi(f[15]);
            females = std::stoi(f[16]);
            householdschildren = std::stoi(f[17]);
            hispanic = std::stoi(f[18]);
            subcategory = (int8_t) std::stoi(f[19]);
            category = (int8_t) std::stoi(f[20]);
            categorycluster = (int8_t) std::stoi(f[21]);
            prize = std::stod(f[22]);
            rgn_cd = std::stoi(f[23]);
            clim_zn_nbr = std::stoi(f[24]);
            tot_area_sq_ft = std::stoi(f[25]);
            sell_area_sq_ft = std::stoi(f[26]);
            avghhi = std::stoi(f[27]);
            supertargetdistance = std::stod(f[28]);
            supertargetdrivetime = std::stod(f[29]);
            targetdistance = std::stod(f[30]);
            targetdrivetime = std::stod(f[31]);
            walmartdistance = std::stod(f[32]);
            walmartdrivetime = std::stod(f[33]);
            walmartsupercenterdistance = std::stod(f[34]);
            walmartsupercenterdrivetime = std::stod(f[35]);
            rain = (int8_t) std::stoi(f[36]);
            snow = (int8_t) std::stoi(f[37]);
            maxtemp = std::stoi(f[38]);
            mintemp = std::stoi(f[39]);
            meanwind = std::stod(f[40]);
            thunder = (int8_t) std::stoi(f[41]);
            inventoryunits = std::stoi(f[42]);
            __av = v;
            nxt = nullptr;
            prv = nullptr;
        }
    ...
    struct V1_R_entry {
        ...
        V1_R_entry(const V1_R_entry &other) : locn(other.locn), dateid(other.dateid), ksn(other.ksn), rain(other.rain),
                                              __av(other.__av), nxt(nullptr), prv(nullptr) {}
        ...
        FORCE_INLINE V1_R_entry
        &

        modify(const int c0, const int c1, const int c2, const int8_t c3) {
            locn = c0;
            dateid = c1;
            ksn = c2;
            rain = c3;
    ...
    struct V1_R_mapkey0123_idxfn {
        FORCE_INLINE static size_t

        hash(const V1_R_entry &e) {
            size_t h = 0;
    ...
    struct dV1_R_entry {
        ...
        dV1_R_entry(const dV1_R_entry &other) : locn(other.locn), dateid(other.dateid), ksn(other.ksn),
                                                rain(other.rain), __av(other.__av), nxt(nullptr), prv(nullptr) {}
    ...
    struct V2_R_entry {
        ...
        V2_R_entry(const V2_R_entry &other) : locn(other.locn), dateid(other.dateid), __av(other.__av), nxt(nullptr),
                                              prv(nullptr) {}
        ...
        FORCE_INLINE V2_R_entry
        &

        modify(const int c0, const int c1) {
            locn = c0;
            dateid = c1;
            return *this;
        }
    ...
    struct dV2_R_entry {
        ...
        dV2_R_entry(const dV2_R_entry &other) : locn(other.locn), dateid(other.dateid), __av(other.__av), nxt(nullptr),
                                                prv(nullptr) {}
    ...
    struct DELTA_R_entry {
        ...
        explicit DELTA_R_entry(const int c0, const int c1, const int c2, const int c3, const int c4, const int c5,
                               const int c6, const int c7, const int c8, const DOUBLE_TYPE c9, const int c10,
                               const int c11, const int c12, const int c13, const int c14, const int c15, const int c16,
                               const int c17, const int c18, const int8_t c19, const int8_t c20, const int8_t c21,
                               const DOUBLE_TYPE c22, const int c23, const int c24, const int c25, const int c26,
                               const int c27, const DOUBLE_TYPE c28, const DOUBLE_TYPE c29, const DOUBLE_TYPE c30,
                               const DOUBLE_TYPE c31, const DOUBLE_TYPE c32, const DOUBLE_TYPE c33,
                               const DOUBLE_TYPE c34, const DOUBLE_TYPE c35, const int8_t c36, const int8_t c37,
                               const int c38, const int c39, const DOUBLE_TYPE c40, const int8_t c41, const int c42,
                               const long c43) {
            locn = c0;
            ksn = c1;
            dateid = c2;
        ...
        DELTA_R_entry(const DELTA_R_entry &other) : locn(other.locn), ksn(other.ksn), dateid(other.dateid),
                                                    zip(other.zip), population(other.population), white(other.white),
                                                    asian(other.asian), pacific(other.pacific), black(other.black),
                                                    medianage(other.medianage),
                                                    occupiedhouseunits(other.occupiedhouseunits),
                                                    houseunits(other.houseunits), families(other.families),
                                                    households(other.households), husbwife(other.husbwife),
                                                    males(other.males), females(other.females),
                                                    householdschildren(other.householdschildren),
                                                    hispanic(other.hispanic), subcategory(other.subcategory),
                                                    category(other.category), categorycluster(other.categorycluster),
                                                    prize(other.prize), rgn_cd(other.rgn_cd),
                                                    clim_zn_nbr(other.clim_zn_nbr),
                                                    tot_area_sq_ft(other.tot_area_sq_ft),
                                                    sell_area_sq_ft(other.sell_area_sq_ft), avghhi(other.avghhi),
                                                    supertargetdistance(other.supertargetdistance),
                                                    supertargetdrivetime(other.supertargetdrivetime),
                                                    targetdistance(other.targetdistance),
                                                    targetdrivetime(other.targetdrivetime),
                                                    walmartdistance(other.walmartdistance),
                                                    walmartdrivetime(other.walmartdrivetime),
                                                    walmartsupercenterdistance(other.walmartsupercenterdistance),
                                                    walmartsupercenterdrivetime(other.walmartsupercenterdrivetime),
                                                    rain(other.rain), snow(other.snow), maxtemp(other.maxtemp),
                                                    mintemp(other.mintemp), meanwind(other.meanwind),
                                                    thunder(other.thunder), inventoryunits(other.inventoryunits),
                                                    __av(other.__av), nxt(nullptr), prv(nullptr) {}
        ...
        FORCE_INLINE DELTA_R_entry
        &

        modify(const int c0, const int c1, const int c2, const int c3, const int c4, const int c5, const int c6,
               const int c7, const int c8, const DOUBLE_TYPE c9, const int c10, const int c11, const int c12,
               const int c13, const int c14, const int c15, const int c16, const int c17, const int c18,
               const int8_t c19, const int8_t c20, const int8_t c21, const DOUBLE_TYPE c22, const int c23,
               const int c24, const int c25, const int c26, const int c27, const DOUBLE_TYPE c28, const DOUBLE_TYPE c29,
               const DOUBLE_TYPE c30, const DOUBLE_TYPE c31, const DOUBLE_TYPE c32, const DOUBLE_TYPE c33,
               const DOUBLE_TYPE c34, const DOUBLE_TYPE c35, const int8_t c36, const int8_t c37, const int c38,
               const int c39, const DOUBLE_TYPE c40, const int8_t c41, const int c42) {
            locn = c0;
            ksn = c1;
            dateid = c2;
            zip = c3;
    ...
    struct DELTA_R_mapkey0123456789101112131415161718192021222324252627282930313233343536373839404142_idxfn {
        ...
        FORCE_INLINE static bool equals(const DELTA_R_entry &x, const DELTA_R_entry &y) {
            return x.locn == y.locn && x.ksn == y.ksn && x.dateid == y.dateid && x.zip == y.zip &&
                   x.population == y.population && x.white == y.white && x.asian == y.asian && x.pacific == y.pacific &&
                   x.black == y.black && x.medianage == y.medianage && x.occupiedhouseunits == y.occupiedhouseunits &&
                   x.houseunits == y.houseunits && x.families == y.families && x.households == y.households &&
                   x.husbwife == y.husbwife && x.males == y.males && x.females == y.females &&
                   x.householdschildren == y.householdschildren && x.hispanic == y.hispanic &&
                   x.subcategory == y.subcategory && x.category == y.category &&
                   x.categorycluster == y.categorycluster && x.prize == y.prize && x.rgn_cd == y.rgn_cd &&
                   x.clim_zn_nbr == y.clim_zn_nbr && x.tot_area_sq_ft == y.tot_area_sq_ft &&
                   x.sell_area_sq_ft == y.sell_area_sq_ft && x.avghhi == y.avghhi &&
                   x.supertargetdistance == y.supertargetdistance && x.supertargetdrivetime == y.supertargetdrivetime &&
                   x.targetdistance == y.targetdistance && x.targetdrivetime == y.targetdrivetime &&
                   x.walmartdistance == y.walmartdistance && x.walmartdrivetime == y.walmartdrivetime &&
                   x.walmartsupercenterdistance == y.walmartsupercenterdistance &&
                   x.walmartsupercenterdrivetime == y.walmartsupercenterdrivetime && x.rain == y.rain &&
                   x.snow == y.snow && x.maxtemp == y.maxtemp && x.mintemp == y.mintemp && x.meanwind == y.meanwind &&
                   x.thunder == y.thunder && x.inventoryunits == y.inventoryunits;
        }
    };
    ...
    struct data_t : tlq_t {
        ...
        void on_batch_update_R(const std::vector<DELTA_R_entry>::iterator &begin,
                               const std::vector<DELTA_R_entry>::iterator &end) {
